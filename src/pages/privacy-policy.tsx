                ...
                <div className='max-w-xl px-5 xl:px-0'>
                    ...
                    <p className="mt-6 text-gray-500 text-justify" style={{ opacity: 1 }}>
                        <span style={{ display: 'inline-block', verticalAlign: 'top', textDecoration: 'inherit', maxWidth: '541px' }}>
                            ...
                            Please note that we don&apos;t do anything with your calendar and only perform operations which you ask Arjun to perform, such as creating or modifying events and tasks. 
                            ...
                            You can request to delete this data at any time. We don&apos;t do anything with your data other than to store it for conversation history purposes.
